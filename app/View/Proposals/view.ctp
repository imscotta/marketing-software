...
<h2><?php echo __('Proposal'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo $this->Html->link($proposal['Organization']['id'], array('controller' => 'organizations', 'action' => 'view', $proposal['Organization']['id'])); ?>
			&nbsp;
		</dd>
		...
		<dd>
			<?php echo h($proposal['Proposal']['description']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Interested Components'); ?></dt>
		<dd>
			<?php echo h($proposal['Proposal']['interested_components']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Timeframe'); ?></dt>
		<dd>
			<?php echo h($proposal['Proposal']['timeframe']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<?php if (!empty($proposal['Activity'])): ?>
		<dl>
			<dt><?php echo __('Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['id']; ?>
&nbsp;</dd>
		<dt><?php echo __('User Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['user_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Organization Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['organization_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Contact Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['contact_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Interaction Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['interaction_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Task Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['task_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Post Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['post_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Comment Id'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['comment_id']; ?>
&nbsp;</dd>
		<dt><?php echo __('Object Type'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['object_type']; ?>
&nbsp;</dd>
		<dt><?php echo __('Method'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['method']; ?>
&nbsp;</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['created']; ?>
&nbsp;</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
	<?php echo $proposal['Activity']['modified']; ?>
&nbsp;</dd>
		</dl>
	<?php endif; ?>
		<div class="actions">
			<ul>
				<li><?php echo $this->Html->link(__('Edit Activity'), array('controller' => 'activities', 'action' => 'edit', $proposal['Activity']['id'])); ?></li>
			</ul>
		</div>
	</div>
