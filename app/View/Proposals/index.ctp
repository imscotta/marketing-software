...
<div class="proposals index">
	...
	<tr>
		<td>
			<?php echo $this->Html->link($proposal['Organization']['name'], array('controller' => 'organizations', 'action' => 'view', $proposal['Organization']['id'])); ?>
		</td>
		<td><?php echo h($proposal['Proposal']['name']); ?>&nbsp;</td>
		<td><?php echo h($proposal['Proposal']['description']); ?>&nbsp;</td>
		<td><?php echo h($proposal['Proposal']['timeframe']); ?>&nbsp;</td>
		<td><?php echo h($proposal['Proposal']['created']); ?>&nbsp;</td>
		<td class="actions">
