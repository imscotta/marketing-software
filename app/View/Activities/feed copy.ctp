<div class="activities index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($activity['Organization']['name'], array('controller' => 'organizations', 'action' => 'view', $activity['Organization']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($activity['Contact']['title'], array('controller' => 'contacts', 'action' => 'view', $activity['Contact']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($activity['Interaction']['type'], array('controller' => 'interactions', 'action' => 'view', $activity['Interaction']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($activity['Task']['name'], array('controller' => 'tasks', 'action' => 'view', $activity['Task']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($activity['Post']['comment'], array('controller' => 'posts', 'action' => 'view', $activity['Post']['id'])); ?>
		</td>
		<td>
