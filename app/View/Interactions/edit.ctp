...
<?php echo $this->Form->create('Interaction', array(
	...
	<fieldset>
		<legend><?php echo __('Edit Interaction'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Interaction.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Interaction.id'))); ?></li>
