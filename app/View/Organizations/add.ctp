            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-leaf fa-fw"></i> Organization
...
<?php echo $this->Form->create('Organization', array(
	...
	<?php
		...
		$options = array('California' => 'California', 'Oregon' => 'Oregon', 'Washington' => 'Washington');
		echo $this->Form->label('state');
		echo $this->Form->select('state', $options, array('default' => 'California'));
		echo $this->Form->input('email');
		echo $this->Form->input('phone');
		echo $this->Form->input('description');
		echo $this->Form->input('notes');
		$options2 = array('Prospect' => 'Prospect', 'Lead' => 'Lead', 'Customer' => 'Customer', 'Not Interested' => 'Not Interested');
		echo $this->Form->label('lead_status');
		echo $this->Form->select('lead_status', $options2, array('default' => 'Prospect'));
		echo $this->Form->input('timeframe');
	?>
	</fieldset>
